...
def main(args): #主函数
    ...
    elif args.checkpoint_path.endswith("safetensors"):
        checkpoint = load_st(args.checkpoint_path)
    ...
    if args.vae_checkpoint_path is not None:
        ...
        elif args.vae_checkpoint_path.endswith("safetensors"):
            vae_checkpoint = load_st(args.vae_checkpoint_path)
